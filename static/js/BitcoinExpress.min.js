...
var BitcoinExpress = {
  ...
  wellKnownWallets: JSON.parse('[{"domain":"' + domain + '","protocol":"' + protocol + '","port":"' + port + '","path":"","probe":"/wallet/probe.html","wallet":"/wallet/wallet.html"}, {"domain":"' + domain + '","protocol":"' + protocol + '","port":"' + port + '","path":"","probe":"/wallet-v3/probe.html","wallet":"/wallet-v3/wallet.html"}]'),
  ...
  _ : {
    startWallet: function (url, params) {
      ...
      if (params.PaymentRequest) {
        ...
        if (PaymentRequest.PaymentDetails && PaymentRequest.PaymentDetails.payment_url) {
            ...
            case "payment" :
              ...
              $.ajax({
                ...
                success: function (paymentAck_container) {
                  ...
                  if (!(PaymentAck.id && PaymentAck.id == Payment.id)) {
                    event.source.postMessage({
                  ...
                  var paymentAckReceivedEvents = function (event) {
                    ...
                    if (ackMessage && ackMessage.fn == "paymentAckAck") {
    ...
    show_iframe: function (iframe_id, params, show, position) {
      ...
      if (iframe.length)  {
        ...
        } else if (position !== null && position.left && position.top) {
    ...
    getWalletDomain: function (paymentRequestContainer) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var registerProbe = function (event) {
          ...
          var message = event.data;
          if (message && typeof(message) == "object" && message.fn === "probe") {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (walletId) {
          ...
          var gomodalReceivedEvent = function (event) {
            ...
            if (data && data.fn == "relocateWallet") {
              $("#" + data.walletId).css({
                left: data.left,
                top: data.top,
                position: 'absolute'
